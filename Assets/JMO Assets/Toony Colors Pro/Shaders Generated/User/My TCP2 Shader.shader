	...
	SubShader
	{
		...
		HLSLINCLUDE
			...
			struct Varyings
			{
				...
				float pack1 : TEXCOORD2; /* pack1.x = rim */
...
/* TCP_DATA u config(unity:"2020.3.5f1";ver:"2.7.2";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2020_1","CRISP_RAMP_NO_AA","RIM_OUTLINE","RIM_SHADER_FEATURE","RIM_VERTEX","SHADOW_LINE","SHADOW_LINE_CRISP_AA","OUTLINE","OUTLINE_URP_FEATURE","OUTLINE_FAKE_RIM","OUTLINE_MIN_WIDTH","OUTLINE_MAX_WIDTH","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Outline"];shaderProperties:list[];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH e4c4e05f3a7c2b03a4e0708b0fc2f9bb */
