...
public class SimpleWalkerController : Controller
{
    ...
    private Vector3 CalculateMovementDirection()
    {
        ...
        else
        {
            ...
            //_direction += Vector3.ProjectOnPlane(cameraTransform.right, tr.up).normalized * characterInput.GetHorizontalMovementInput() * factorDir;
